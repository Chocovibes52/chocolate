...
import { Building2, Gift, Factory, Package } from "lucide-react";

export const Route = createFileRoute("/b2b")({
  head: () => ({
    meta: [
      { title: "Corporate & B2B Chocolate Gifting — ChocoVibes" },
      {
        name: "description",
        content:
          "Custom corporate chocolate gifting, bulk orders, wholesale, and private label by ChocoVibes.",
      },
      {
        property: "og:title",
        content: "Corporate & B2B Chocolate Gifting — ChocoVibes",
      },
      {
      ...
      <section className="relative bg-primary text-primary-foreground py-24 md:py-32">
        <div className="container-luxe max-w-3xl">
          ...
          <p className="mt-6 text-primary-foreground/80 text-lg max-w-xl">
            From 50 boardroom favours to 50,000 Diwali hampers — private label,
            custom packaging, and nationwide fulfillment. Tell us what you're
            planning.
          </p>
        </div>
      </section>
        ...
        <div className="container-luxe max-w-3xl">
          ...
          <form onSubmit={onSubmit} className="mt-10 grid sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2 flex justify-end">
              <button disabled={loading} type="submit" className="btn-cocoa">
