...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Shop the full ChocoVibes collection — dark, milk, and white chocolate creations, hand-tempered in small batches." },
      { property: "og:title", content: "Shop All Chocolates — ChocoVibes" },
      { property: "og:description", content: "Shop the full ChocoVibes collection — dark, milk, and white chocolate creations." },
