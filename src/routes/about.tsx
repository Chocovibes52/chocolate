  ...
  head: () => ({
    meta: [
      { title: "Our Story — ChocoVibes" },
      {
        name: "description",
        content:
          "Single-origin cacao, small-batch tempering, and an obsession with quality. The story of ChocoVibes.",
      },
      { property: "og:title", content: "Our Story — ChocoVibes" },
      {
        property: "og:description",
        content:
          "Single-origin cacao, small-batch tempering. The story of ChocoVibes.",
      },
    ],
  }),
  component: About,
    ...
    <main>
      <section className="container-luxe pt-20 pb-10 max-w-3xl text-center mx-auto">
        ...
        <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
          ChocoVibes began in a Mumbai studio kitchen in 2019, with a single
          copper pot and a stubborn belief that chocolate deserved better. Today
          we work directly with cacao growers in the Western Ghats, tempering
          each batch by hand.
        </p>
      </section>
